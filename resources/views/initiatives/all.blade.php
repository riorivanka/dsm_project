        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
            ...
            <div class="mb-3 mb-md-0 d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="text-muted m-0 font-weight-bold" style="font-size: 0.75rem; letter-spacing: 0.5px;">ALL GROUP INITIATIVE</p>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0 text-nowrap align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center font-weight-bold text-muted pl-4" style="border-color: #edf2f7; padding: 1.2rem 1rem;">2</td>
                                <td class="font-weight-bold" style="color: #a0aec0; font-size: 0.8rem; border-color: #edf2f7; padding: 1.2rem 1rem;">CORPORATE INITIATIVE</td>
                                <td style="border-color: #edf2f7; padding: 1.2rem 1rem;">
                                    <a href="#" class="font-weight-bold text-dark text-decoration-none" style="font-size: 0.95rem; border-bottom: 1px solid #cbd5e0; padding-bottom: 2px; transition: border-color 0.2s;">
                                        TES DSM HARDCODE
                                ...
                                <td class="text-center" style="border-color: #edf2f7; padding: 1.2rem 1rem;">
                                    <span class="font-weight-bold rounded-pill" style="padding: 6px 14px; font-size: 0.7rem; letter-spacing: 0.5px; background-color: #e6f4ea; color: #28a745;">EFFICIENCY</span>
                                </td>
                                <td style="font-size: 0.9rem; color: #4a5568; border-color: #edf2f7; padding: 1.2rem 1rem;">786 toko menggunakan Mobile Store Support</td>
                                <td class="font-weight-bold text-dark pr-4" style="border-color: #edf2f7; padding: 1.2rem 1rem;">786</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
