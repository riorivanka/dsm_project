    ...
    <div class="container-fluid px-md-4">
        ...
        <div class="row mb-4 justify-content-center">
            <div class="col-md-4 mb-3 mb-md-0">
                <a href="{{ route('initiative.all') }}" class="btn-initiative">All Group Initiative</a>
            </div>
            <div class="col-md-4 mb-3 mb-md-0">
                <a href="{{ route('initiative.corporate') }}" class="btn-initiative">Corporate Group Initiative</a>
            </div>
            <div class="col-md-4 mb-0">
                <a href="{{ route('initiative.divisional') }}" class="btn-initiative">Divisional Group Initiative</a>
            </div>
        </div>
